 ...
 */
dmod_dmfsi_dif( 1.0, int, _init, (const char* config) );

/**
 * @brief Deinitialize the file system
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _deinit, (void) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _fopen, (void** fp, const char* path, int mode, int attr) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _fclose, (void* fp) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _fread, (void* fp, void* buffer, size_t size, size_t* read) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _fwrite, (void* fp, const void* buffer, size_t size, size_t* written) );
 ...
 */
dmod_dmfsi_dif( 1.0, long, _lseek, (void* fp, long offset, int whence) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _ioctl, (void* fp, int request, void* arg) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _sync, (void* fp) );
 ...
 */
dmod_dmfsi_dif( 1.0, int, _getc, (void* fp) );
 ...
 */
dmod_dmfsi_dif( 1.0, int, _putc, (void* fp, int c) );
 ...
 */
dmod_dmfsi_dif( 1.0, long, _tell, (void* fp) );
 ...
 */
dmod_dmfsi_dif( 1.0, int, _eof, (void* fp) );
 ...
 */
dmod_dmfsi_dif( 1.0, long, _size, (void* fp) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _fflush, (void* fp) );
 ...
 * @return Error code
 */
dmod_dmfsi_dif( 1.0, int, _error, (void* fp) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _opendir, (void** dp, const char* path) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _closedir, (void* dp) );
 ...
 */
dmod_dmfsi_dif( 1.0, int, _readdir, (void* dp, dmfsi_dir_entry_t* entry) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _stat, (const char* path, dmfsi_stat_t* stat) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _unlink, (const char* path) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _rename, (const char* oldpath, const char* newpath) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _chmod, (const char* path, int mode) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _utime, (const char* path, uint32_t atime, uint32_t mtime) );
 ...
 * @return DMFSI_OK on success, error code otherwise
 */
dmod_dmfsi_dif( 1.0, int, _mkdir, (const char* path, int mode) );
 ...
 */
dmod_dmfsi_dif( 1.0, int, _direxists, (const char* path) );
